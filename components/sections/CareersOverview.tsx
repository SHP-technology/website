      ...
      <div className="container">
        ...
        <div className="flex flex-col gap-6 max-w-4xl mx-auto">
          {jobsData.map((job) => (
            <div
              key={job.id}
              className="glass-card p-8 rounded-3xl flex flex-col md:flex-row md:items-center justify-between gap-6 hover:border-amber-500/50 transition-all duration-300"
            >
              <div>
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-amber-500 hover:bg-amber-600 text-slate-950 font-bold text-sm shrink-0 transition-colors cursor-pointer"
              >
                <span>View Role</span>
